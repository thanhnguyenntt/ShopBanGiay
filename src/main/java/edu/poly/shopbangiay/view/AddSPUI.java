 ...
 * @author Quang
 */
public class AddSPUI extends javax.swing.JDialog {

    /**
     * Creates new form AddSPUI
     */
    ...
    public AddSPUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddSPUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
